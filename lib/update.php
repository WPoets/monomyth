...
/******************Change this*******************/
$monomyth_update_api_url = 'http://getawesomestudio.com/releases/';
/************************************************/
...
add_filter('pre_set_site_transient_update_themes', 'monomyth_check_for_update');

function monomyth_check_for_update($checked_data) {
	global $wp_version, $theme_version, $theme_base, $monomyth_update_api_url;
	...
	$raw_response = wp_remote_post($monomyth_update_api_url, $send_for_check);
...
add_filter('themes_api', 'monomyth_theme_update_api_call', 10, 3);

function monomyth_theme_update_api_call($def, $action, $args) {
	global $theme_base, $monomyth_update_api_url, $theme_version, $monomyth_update_api_url;
	...
	$request = wp_remote_post($monomyth_update_api_url, $request_string);
